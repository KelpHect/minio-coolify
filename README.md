...
- Auto-generates and assigns two public domains: one for the S3 API (`SERVICE_FQDN_MINIO_9000`) and one for the web console (`SERVICE_FQDN_MINIO_9001`)
...
| `SERVICE_FQDN_MINIO_9000` | Auto-generated public domain for the S3 API endpoint (port 9000). Used as `MINIO_SERVER_URL`. |
| `SERVICE_FQDN_MINIO_9001` | Auto-generated public domain for the web console (port 9001). Used as `MINIO_BROWSER_REDIRECT_URL`. |
